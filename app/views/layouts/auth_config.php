...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>gree_google_auth/php/auth_config.php at master · pascal-borghino/gree_google_auth</title>
...
<meta content="oWXeq36LydAOyd7W6GRSD+mQGui0qZ6loe/qaNmbylU=" name="csrf-token" />
    ...
    <link href="https://git.gree-dev.net/assets/github2-2820f1a9e24938972c5183937936b2b58a9ce909.css" media="screen" rel="stylesheet" type="text/css" />
      ...
      <script src="https://git.gree-dev.net/assets/github-26130aee477bd81cba946241a8a5260a074ca624.js" type="text/javascript"></script>
        ...
        <link rel='permalink' href='/pascal-borghino/gree_google_auth/blob/dc3655fd651da8f1d20610e1c4cc6f47e2fd624c/php/auth_config.php'>
      ...
      <div class="select-menu-modal-holder js-menu-content js-navigation-container js-select-menu-pane">
        ...
        <div class="select-menu-modal js-select-menu-pane">
          ...
          <div class="select-menu-list js-filter-tab js-filter-branches css-truncate" data-filterable-for="commitish-filter-field" data-filterable-type="substring">
              ...
              <div class="select-menu-item js-navigation-item js-navigation-target selected">
                <span class="select-menu-checkmark mini-icon mini-icon-confirm"></span>
                <a href="/pascal-borghino/gree_google_auth/blob/master/php/auth_config.php" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
              </div> <!-- /.select-menu-item -->
...
<!-- blob contrib key: blob_contributors:v21:52c0bc43e5ce685f069f172a537e049e -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:52c0bc43e5ce685f069f172a537e049e -->
...
<div id="slider">
    <div class="frame-meta">
      ...
      <a href="/pascal-borghino/gree_google_auth/find/master" class="js-slide-to" data-hotkey="t" style="display:none">Show File Finder</a>
        ...
        <div class="commit commit-loader file-history-tease js-deferred-content" data-url="/pascal-borghino/gree_google_auth/contributors/master/php/auth_config.php">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/pascal-borghino/gree_google_auth/blob/dc3655fd651da8f1d20610e1c4cc6f47e2fd624c/php/auth_config.php" data-title="gree_google_auth/php/auth_config.php at master · pascal-borghino/gree_google_auth · GitHub" data-type="blob">
              ...
              <ul class="button-group actions">
                  <li>
                        <a class="grouped-button minibutton bigger lighter tooltipped leftwards"
                           ...
                           href="/pascal-borghino/gree_google_auth/edit/master/php/auth_config.php"
                           data-method="post" rel="nofollow">Edit</a>
                  </li>
                <li><a href="/pascal-borghino/gree_google_auth/raw/master/php/auth_config.php" class="button minibutton grouped-button bigger lighter" id="raw-url">Raw</a></li>
                  <li><a href="/pascal-borghino/gree_google_auth/blame/master/php/auth_config.php" class="button minibutton grouped-button bigger lighter">Blame</a></li>
                <li><a href="/pascal-borghino/gree_google_auth/commits/master/php/auth_config.php" class="button minibutton grouped-button bigger lighter" rel="nofollow">History</a></li>
              </ul>
...
<span id="L30" rel="#L30">30</span>
          ...
          <td width="100%">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="o">&lt;?</span><span class="nx">php</span></div><div class='line' id='LC2'><span class="c1">// Analytics will be using a load balancer in front of the webserver - we need to use cookie</span></div><div class='line' id='LC3'><span class="k">require_once</span> <span class="s1">&#39;./google-api-php-client/src/Google_Client.php&#39;</span><span class="p">;</span></div><div class='line' id='LC4'><span class="k">require_once</span> <span class="s1">&#39;./google-api-php-client/src/contrib/Google_Oauth2Service.php&#39;</span><span class="p">;</span></div><div class='line' id='LC5'><span class="c1">//</span></div><div class='line' id='LC6'><span class="k">const</span> <span class="no">APP_NAME</span> <span class="o">=</span> <span class="s1">&#39;GII Stats&#39;</span><span class="p">;</span></div><div class='line' id='LC7'><span class="k">const</span> <span class="no">GOOGLE_CLIENT_ID</span> <span class="o">=</span> <span class="s1">&#39;416316918168.apps.googleusercontent.com&#39;</span><span class="p">;</span></div><div class='line' id='LC8'><span class="k">const</span> <span class="no">GOOGLE_CLIENT_SECRET</span> <span class="o">=</span> <span class="s1">&#39;wii9RnMQ6pTBZbPUOHgAlBQT&#39;</span><span class="p">;</span></div><div class='line' id='LC9'><span class="k">const</span> <span class="no">EXPIRE</span> <span class="o">=</span> <span class="mi">345600</span><span class="p">;</span></div><div class='line' id='LC10'><span class="k">const</span> <span class="no">URL_SIGNED_IN</span>  <span class="o">=</span> <span class="s1">&#39;http://localhost:8888/index.php&#39;</span><span class="p">;</span></div><div class='line' id='LC11'><span class="k">const</span> <span class="no">URL_SIGN_OUT</span>  <span class="o">=</span> <span class="s1">&#39;http://localhost:8888/auth.php?gga=logout&#39;</span><span class="p">;</span></div><div class='line' id='LC12'><span class="k">const</span> <span class="no">URL_SIGNED_ERROR</span>  <span class="o">=</span> <span class="s1">&#39;http://localhost:8888/auth.php?gga=forbidden&#39;</span><span class="p">;</span></div><div class='line' id='LC13'><span class="k">const</span> <span class="no">URL_SIGNED_ERROR_TPL</span>  <span class="o">=</span> <span class="s1">&#39;&#39;</span><span class="p">;</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'><span class="k">const</span> <span class="no">COOKIE_ACCESS_TOKEN</span> <span class="o">=</span> <span class="s1">&#39;gii_stats&#39;</span><span class="p">;</span></div><div class='line' id='LC16'><span class="k">const</span> <span class="no">COOKIE_REFRESH_TOKEN</span> <span class="o">=</span> <span class="s1">&#39;gii_stats_refresh&#39;</span><span class="p">;</span></div><div class='line' id='LC17'><span class="k">const</span> <span class="no">COOKIE_PATH</span> <span class="o">=</span> <span class="s1">&#39;/&#39;</span><span class="p">;</span></div><div class='line' id='LC18'><span class="k">const</span> <span class="no">COOKIE_DOMAIN</span> <span class="o">=</span> <span class="s1">&#39;.gree-dev.net&#39;</span><span class="p">;</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><br/></div><div class='line' id='LC21'><span class="k">function</span> <span class="nf">getRefreshToken</span><span class="p">(</span><span class="nv">$client</span><span class="p">)</span></div><div class='line' id='LC22'><span class="p">{</span></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nv">$authObj</span> <span class="o">=</span> <span class="nb">json_decode</span><span class="p">(</span><span class="nv">$client</span><span class="o">-&gt;</span><span class="na">getAccessToken</span><span class="p">());</span></div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nb">isset</span><span class="p">(</span><span class="nv">$authObj</span><span class="o">-&gt;</span><span class="na">refresh_token</span><span class="p">))</span> <span class="p">{</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="nv">$authObj</span><span class="o">-&gt;</span><span class="na">refresh_token</span><span class="p">;</span></div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="k">null</span><span class="p">;</span></div><div class='line' id='LC28'><span class="p">}</span></div><div class='line' id='LC29'><br/></div><div class='line' id='LC30'><span class="cp">?&gt;</span><span class="x"></span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.05872s from git-gree-dev-net">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.06047' data-host='git-gree-dev-net'></span>
